...
namespace Garage
{
    public class GarageInteraction
    {
        ...
        public void ListAllVehicles()
        {
            ...
            IVehicle[] vehicles = garageHandler.ListAllVehiclesInGarage();

            bool found = false; // Track if any vehicles were found

            foreach (var vehicle in vehicles)
            {
                if (vehicle != null)
                {
                    ui.DisplayOutput($"{vehicle.GetType().Name} - Registration Number: {vehicle.RegistrationNumber}");
                    found = true;
                }
            }
            ...
            if (!found)
            {
                ui.DisplayOutput("The garage is empty. There are no vehicles.");
            }
        }
        ...
        public void PopulateGarage()
        {
            ...
            {
                string registrationNumber = $"ABC{random.Next(1, 999)}";
